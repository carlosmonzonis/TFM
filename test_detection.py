...
import utils.detections_to_file as Writter
...
def predictions_to_kitti_format(img_detections, calib, img_shape_2d, img_size, RGB_Map=None):
    ...
    for index, l in enumerate(predictions):
        ...
        elif l[0] == 4: str="Truck"
        elif l[0] == 5: str="Person_sitting"
        elif l[0] == 6: str="Tram"
        elif l[0] == 7: str="Misc"
        elif l[0] == 8: str="DontCare"
...
if __name__ == "__main__":
    ...
    for index, (img_paths, bev_maps) in enumerate(data_loader):
        ...
        #Saco la parte del nombre que me interesa
